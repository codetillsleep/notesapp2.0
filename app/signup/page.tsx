...
export default function SignupPage() {
  ...
  return (
    <div className={`min-h-screen  flex transition-colors duration-500 ${isDark ? "bg-[#080b18]" : "bg-slate-50"}`}>

      {/* ── Left Panel ── */}
      <div className="hidden lg:flex lg:w-5/12 relative flex-col justify-between p-12 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-violet-950 via-indigo-950 to-blue-950" />
        ...
        />
        <div className="absolute top-1/3 -left-20 w-72 h-72 bg-violet-400/15 rounded-full blur-3xl animate-float" />
        <div className="absolute bottom-1/4 right-0 w-64 h-64 bg-blue-400/20 rounded-full blur-3xl animate-float" style={{ animationDelay: "3s" }} />
        ...
        <div className="relative z-10 space-y-8">
          <div className="space-y-4">
            <div className="flex gap-1.5">
              {[...Array(5)].map((_, i) => (
                <div key={i} className="w-2 h-2 rounded-full bg-emerald-400" style={{ opacity: 1 - i * 0.15 }} />
              ))}
            </div>
            ...
            <p className="text-white/50 text-sm leading-relaxed">
              Join GGSIPU students who already use 10GPA to get organized, study better, and score higher.
            </p>
          </div>
            ...
            {[
              ...
              <div key={item.text} className="flex items-center gap-3">
                <div className="w-7 h-7 rounded-lg bg-white/10 flex items-center justify-center shrink-0">
                  <item.icon className="w-3.5 h-3.5 text-violet-300" />
                </div>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12 relative overflow-hidden">
        ...
        <div className="absolute bottom-20 left-20 w-72 h-72 bg-violet-500/5 rounded-full blur-3xl pointer-events-none" />
        ...
        <div className="w-full max-w-md animate-fadeIn">
          ...
          <div className="mb-8 animate-slideDown">
            ...
            <p className={`text-sm ${isDark ? "text-gray-500" : "text-gray-500"}`}>
              Join thousands of students and start your journey
            </p>
          </div>
          ...
          <div className="space-y-4 animate-slideUp">
            ...
            <div>
              ...
              <div className={`relative flex items-center rounded-xl border transition-all duration-200 ${focusedField === "name"
                ? "border-indigo-500 shadow-[0_0_0_3px_rgba(99,102,241,0.12)]"
                : isDark ? "border-white/10" : "border-gray-200"
                } ${isDark ? "bg-white/5" : "bg-white"}`}>
                <UserIcon className={`absolute left-3.5 w-4 h-4 transition-colors ${focusedField === "name" ? "text-indigo-400" : isDark ? "text-gray-600" : "text-gray-400"
                  }`} />
                <input
                  type="text"
                  ...
                  className={`w-full pl-10 pr-4 py-3 rounded-xl text-sm bg-transparent focus:outline-none ${isDark ? "text-white placeholder:text-gray-600" : "text-gray-900 placeholder:text-gray-400"
                    }`}
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className={`relative flex items-center rounded-xl border transition-all duration-200 ${focusedField === "email"
                ...
                <Mail className={`absolute left-3.5 w-4 h-4 transition-colors ${focusedField === "email" ? "text-indigo-400" : isDark ? "text-gray-600" : "text-gray-400"
                  }`} />
                <input
                  type="email"
            ...
            <div>
              ...
              <div className={`relative flex items-center rounded-xl border transition-all duration-200 ${focusedField === "password"
                ...
                <Lock className={`absolute left-3.5 w-4 h-4 transition-colors ${focusedField === "password" ? "text-indigo-400" : isDark ? "text-gray-600" : "text-gray-400"
                  }`} />
                <input
                  type="password"
                  placeholder="••••••••"
                ...
                <div className="mt-2 space-y-1.5">
                  <div className="flex gap-1.5">
                    {[1, 2, 3, 4].map((level) => (
                      <div
                        key={level}
                        className={`flex-1 h-1 rounded-full transition-all duration-300 ${passwordStrength >= level
                          ? strengthColor
                  ...
                  <p className={`text-xs ${isDark ? "text-gray-500" : "text-gray-400"}`}>
                    Password strength:{" "}
                    <span className={`font-semibold ${passwordStrength === 1 ? "text-red-400"
            ...
            <button
              ...
              disabled={loading}
              className={`w-full py-3.5 rounded-xl font-bold text-sm flex items-center justify-center gap-2 transition-all duration-300 ${loading
          ...
          <div className="mt-6 animate-slideUp">
            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                ...
                className={`flex items-center justify-center gap-2 py-3 rounded-xl text-sm font-semibold border transition-all duration-200 hover:scale-[1.02] active:scale-[0.98] ${isDark
          ...
          <p className={`text-center text-sm mt-8 animate-slideUp ${isDark ? "text-gray-500" : "text-gray-500"}`}>
            ...
            <a
              href="/login"
              className={`font-bold hover:underline ${isDark ? "text-indigo-400 hover:text-indigo-300" : "text-indigo-600 hover:text-indigo-500"
                }`}
            >
              Sign in →
            </a>
