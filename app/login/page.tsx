        ...
        <div className="w-full max-w-md animate-fadeIn">
          ...
          <div className="space-y-4 animate-slideUp">
            ...
            <div>
              <div className="flex justify-between items-center mb-2">
                ...
                <a
                  ...
                  className={`text-xs font-semibold hover:underline ${isDark ? "text-indigo-400 hover:text-indigo-300" : "text-indigo-600 hover:text-indigo-500"
                    }`}
                >
                  Forgot password?
                </a>
            ...
            <button
              onClick={handleLogin}
              disabled={loading}
              className={`w-full py-3.5 rounded-xl font-bold text-sm flex items-center justify-center gap-2 transition-all duration-300 mt-2 ${loading
            ...
            {/* ── Inline Error Banner ── */}
            {loginError && (
              <div className={`flex items-start gap-3 p-3.5 rounded-xl border animate-fadeIn ${loginError.type === "oauth"
