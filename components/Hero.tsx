      ...
      <div className="w-full max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 xl:gap-16 items-center">
          ...
          <div className="order-2 lg:order-1 flex flex-col items-center lg:items-start text-center lg:text-left space-y-6 sm:space-y-8">
            <h1 className="w-full font-courgette text-prime tracking-tight leading-[0.85] text-[4rem] sm:text-[4.5rem] md:text-[6rem] lg:text-[9rem] xl:text-[13rem]">
              {HERO_TITLE}
            </h1>
            <h2 className="text-lg sm:text-2xl md:text-3xl lg:text-5xl tracking-[0.007em] font-tenor text-text uppercase max-w-3xl">
              {HERO_SUBTITLE}
            </h2>
